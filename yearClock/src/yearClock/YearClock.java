...
public class YearClock extends Application implements MouseInputListener {
	...
	private void display() {
		...
		cb.getSelectionModel().select(t.ld.getMonthValue() - 1);
...
//		cb
		...
		gpane.getColumnConstraints().addAll(column1, column2, column3, column4, column5);
		//gpane.setAlignment(Pos.CENTER);
		gpane.add(lbl, 0, 0, 5, 1);
		gpane.add(add, 0, 1);
...
/*
 * 
 * int day = t.ld.getDayOfMonth(); int month; switch (arg2) { case "JAN": month
 * = 1; break;
 * 
 ...
 * 
 * default: month = 1; System.out.println("error: no month picked"); break; }
 * t.ld = LocalDate.of(ClockAni.currentYear, month, day); t.update();
 * 
 */